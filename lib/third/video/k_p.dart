...
class KaPlayer extends StatefulWidget {
  const KaPlayer({Key? key}) : super(key: key);

  @override
  State<KaPlayer> createState() => _KaPlayerState();
}

class _KaPlayerState extends State<KaPlayer> {
  // var player = Player.network("rtsp://test:0@192.168.10.146:554/ch1/main/av_stream", autoPlay: true);
