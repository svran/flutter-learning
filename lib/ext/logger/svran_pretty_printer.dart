...
/// └──────────────────────────
/// ```
class SvranPrettyPrinter extends LogPrinter {
  ...
  /// For example:
  /// #1      Logger.log (package:ext.logger/src/ext.logger.dart:115:29)
  static final _deviceStackTraceRegex = RegExp(r'#[0-9]+[\s]+(.+) \(([^\s]+)\)');

  /// Matches a stacktrace line as generated by Flutter web.
  /// For example:
  /// packages/ext.logger/src/printers/pretty_printer.dart 91:37
  static final _webStackTraceRegex = RegExp(r'^((packages|dart-sdk)\/[^\s]+\/)');

  /// Matches a stacktrace line as generated by browser Dart.
  /// For example:
  /// dart:sdk_internal
  /// package:ext.logger/src/ext.logger.dart
  ...
  bool _discardDeviceStacktraceLine(String line) {
    ...
    return match.group(2)!.startsWith('package:ext.logger');
  }
  ...
  bool _discardWebStacktraceLine(String line) {
    ...
    return match.group(1)!.startsWith('packages/ext.logger') || match.group(1)!.startsWith('dart-sdk/lib');
  }
  ...
  bool _discardBrowserStacktraceLine(String line) {
    ...
    return match.group(1)!.startsWith('package:ext.logger') || match.group(1)!.startsWith('dart:');
  }
